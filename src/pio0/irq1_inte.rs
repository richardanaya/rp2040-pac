...
pub struct R(crate::R<IRQ1_INTE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IRQ1_INTE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<IRQ1_INTE_SPEC>> for R {
    fn from(reader: crate::R<IRQ1_INTE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IRQ1_INTE` writer"]
pub struct W(crate::W<IRQ1_INTE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IRQ1_INTE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<IRQ1_INTE_SPEC>> for W {
    fn from(writer: crate::W<IRQ1_INTE_SPEC>) -> Self {
        W(writer)
    }
}
