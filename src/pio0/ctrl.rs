...
#[doc = "Field `CLKDIV_RESTART` reader - Force clock dividers to restart their count and clear fractional\\n accumulators. Restart multiple dividers to synchronise them."]
...
#[doc = "Field `CLKDIV_RESTART` writer - Force clock dividers to restart their count and clear fractional\\n accumulators. Restart multiple dividers to synchronise them."]
...
#[doc = "Field `SM_RESTART` reader - Clear internal SM state which is otherwise difficult to access\\n (e.g. shift counters). Self-clearing."]
...
#[doc = "Field `SM_RESTART` writer - Clear internal SM state which is otherwise difficult to access\\n (e.g. shift counters). Self-clearing."]
...
#[doc = "Field `SM_ENABLE` reader - Enable state machine"]
...
#[doc = "Field `SM_ENABLE` writer - Enable state machine"]
