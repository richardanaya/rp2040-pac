...
pub struct R(crate::R<IRQ1_INTS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IRQ1_INTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<IRQ1_INTS_SPEC>> for R {
    fn from(reader: crate::R<IRQ1_INTS_SPEC>) -> Self {
        R(reader)
    }
}
