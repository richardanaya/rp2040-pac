#[doc = "Register `CH0_CTRL_TRIG` reader"]
pub struct R(crate::R<CH0_CTRL_TRIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH0_CTRL_TRIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CH0_CTRL_TRIG_SPEC>> for R {
    fn from(reader: crate::R<CH0_CTRL_TRIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH0_CTRL_TRIG` writer"]
pub struct W(crate::W<CH0_CTRL_TRIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH0_CTRL_TRIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CH0_CTRL_TRIG_SPEC>> for W {
    fn from(writer: crate::W<CH0_CTRL_TRIG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "DMA Channel 0 Control and Status\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch0_ctrl_trig](index.html) module"]
pub struct CH0_CTRL_TRIG_SPEC;
impl crate::RegisterSpec for CH0_CTRL_TRIG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch0_ctrl_trig::R](R) reader structure"]
impl crate::Readable for CH0_CTRL_TRIG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch0_ctrl_trig::W](W) writer structure"]
impl crate::Writable for CH0_CTRL_TRIG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH0_CTRL_TRIG to value 0"]
impl crate::Resettable for CH0_CTRL_TRIG_SPEC {
    #[inline(always)]
