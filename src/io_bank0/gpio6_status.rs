#[doc = "Register `GPIO6_STATUS` reader"]
pub struct R(crate::R<GPIO6_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO6_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO6_STATUS_SPEC>> for R {
    fn from(reader: crate::R<GPIO6_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPIO status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio6_status](index.html) module"]
pub struct GPIO6_STATUS_SPEC;
impl crate::RegisterSpec for GPIO6_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpio6_status::R](R) reader structure"]
impl crate::Readable for GPIO6_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIO6_STATUS to value 0"]
impl crate::Resettable for GPIO6_STATUS_SPEC {
    #[inline(always)]
