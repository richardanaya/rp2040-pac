...
impl core::convert::From<crate::R<GPIO3_CTRL_SPEC>> for R {
...
impl core::convert::From<crate::W<GPIO3_CTRL_SPEC>> for W {
...
#[doc = "`reset()` method sets GPIO3_CTRL to value 0x1f"]
