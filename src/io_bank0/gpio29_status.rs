#[doc = "Register `GPIO29_STATUS` reader"]
pub struct R(crate::R<GPIO29_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO29_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO29_STATUS_SPEC>> for R {
    fn from(reader: crate::R<GPIO29_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPIO status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio29_status](index.html) module"]
pub struct GPIO29_STATUS_SPEC;
impl crate::RegisterSpec for GPIO29_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpio29_status::R](R) reader structure"]
impl crate::Readable for GPIO29_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIO29_STATUS to value 0"]
impl crate::Resettable for GPIO29_STATUS_SPEC {
    #[inline(always)]
