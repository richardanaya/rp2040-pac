#[doc = "Register `GPIO_QSPI_SD1_STATUS` reader"]
pub struct R(crate::R<GPIO_QSPI_SD1_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_QSPI_SD1_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<GPIO_QSPI_SD1_STATUS_SPEC>> for R {
    fn from(reader: crate::R<GPIO_QSPI_SD1_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPIO status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpio_qspi_sd1_status](index.html) module"]
pub struct GPIO_QSPI_SD1_STATUS_SPEC;
impl crate::RegisterSpec for GPIO_QSPI_SD1_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpio_qspi_sd1_status::R](R) reader structure"]
impl crate::Readable for GPIO_QSPI_SD1_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIO_QSPI_SD1_STATUS to value 0"]
impl crate::Resettable for GPIO_QSPI_SD1_STATUS_SPEC {
    #[inline(always)]
