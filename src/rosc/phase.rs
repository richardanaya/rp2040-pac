...
impl core::convert::From<crate::R<PHASE_SPEC>> for R {
...
impl core::convert::From<crate::W<PHASE_SPEC>> for W {
    fn from(writer: crate::W<PHASE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PASSWD` reader - set to 0xaa0\\n any other value enables the output with shift=0"]
...
#[doc = "Field `PASSWD` writer - set to 0xaa0\\n any other value enables the output with shift=0"]
